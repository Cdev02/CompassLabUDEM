...
//Consultar todos los laboratoristas a cargo (Es necesario?)
...
//Actualizar la informaión de un laboratorista a cargo
...
router.delete("/:id", async (req, res) => {
    try {
      const {id_laboratorio, usuario, } = req.params;
      await db.query("DELETE FROM laboratorista_a_cargo WHERE WHERE id_laboratorio = $1 AND usuario = $2", [codigo_ficha, codigo_elemento]);
